...
import type { Location, LocationSource, PvModePeriod, FusionPlant } from '@/lib/types'
...
export default async function LocationSettingsPage({
  ...
  const [locRes, sourcesRes, periodsRes, plantsRes] = await Promise.all([
  ...
  const PUMP_DEVICES = [
    'Aviz 1', 'Aviz 2', 'Aviz Cobertura Nova', 'Aviz Cobertura Velha',
    'Folha da Cholda', 'Moitas 1', 'Moitas 2', 'Pessegueiros',
  ]
      ...
      <Card>
        ...
        <CardContent>
          <SourcesEditor
            ...
            available={PUMP_DEVICES.map((d) => ({ id: d, label: d }))}
